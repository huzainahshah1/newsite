...
(function ($, Drupal, drupalSettings) {
  ...
  Drupal.behaviors.multiSelect = {
    attach: function (context) {
      var $submit = $('.js-form-type-multiselect', context).parents('form').find('.form-submit').once('multiselect');
      var $multiselect = $('select.multiselect-available', context).once('multiselect');
      var $multiselectAvailable = $('select.multiselect-available', context).once('multiselectAvailable');
      var $multiselectSelected = $('select.multiselect-selected', context).once('multiselectSelected');
      var $multiselectAdd = $('li.multiselect-add', context).once('multiselectAdd');
      var $multiselectRemove = $('li.multiselect-remove', context).once('multiselectRemove');
      ...
      $('.action-save.quickedit-button').once('multiselect').click(function(){
        $('select.multiselect-selected').selectAll();
      });
